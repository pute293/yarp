module YARP::Utils::Encoding
  ...
  # (ref. Unicode Consortium Public Data
  #    http://www.unicode.org/Public/MAPPINGS/VENDORS/MICSFT/WindowsBestFit/bestfit1252.txt).
  # Spec says 0xAD maps to hyphen(U+2D), buf here it is assigned to soft-hyphen(U+AD)
  WinAnsiEncoding = Hash[
    [ 0x00,   0x01,   0x02,   0x03,   0x04,   0x05,   0x06,   0x07,   # 00
      ...
      0x20ac, nil,    0x201a, 0x0192, 0x201e, 0x2026, 0x2020, 0x2021, # 80
      0x02c6, 0x2030, 0x0160, 0x2039, 0x0152, nil,    0x017d, nil,    #   
      nil,    0x2018, 0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014, # 90
    ...
    ].each_with_index.collect{|x,i| [i.chr, x.nil? ? 0x2022 : x]}
  ].freeze
